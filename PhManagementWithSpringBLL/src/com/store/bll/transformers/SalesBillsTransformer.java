...
@Component(value = "salesBillsTransformer")
public class SalesBillsTransformer {

   
    public SalesBillsBean transformEntityToBean(SalesBills entity) {
        if (entity == null) {
            return null;
        }
    ...
    public SalesBills transformBeanToEntity(SalesBillsBean bean) {
        if (bean == null) {
            return null;
        }
        SalesBills entity = new SalesBills();
        // transform
